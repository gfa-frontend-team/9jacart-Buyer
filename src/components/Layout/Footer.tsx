    ...
    <footer className="bg-[#182F38] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 mb-8 sm:mb-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/contact" className="text-gray-300 hover:text-white transition-colors">Contact Admin</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li><Link to="/help" className="text-gray-300 hover:text-white transition-colors">Help (Contact Admin)</Link></li>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 lg:gap-8 border-t border-gray-600 pt-6 lg:pt-8">
          ...
          <div className="lg:col-span-1">
            ...
            <form onSubmit={handleSubscribe} className="flex">
              <input
                ...
                className="flex-1 px-3 py-2 bg-transparent border border-gray-500 rounded-l-md text-white placeholder-gray-400 focus:outline-none focus:border-primary text-sm"
                required
              />
              <Button
                type="submit"
          ...
          {/* Download App */}
          <div>
            <h4 className="text-white font-semibold mb-4">Social Link</h4>
